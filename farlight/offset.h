...
#define GameVars BloodHunt::Variables::Get()
	...
	public:
		...
		DWORD offset_u_world = 0x6763160;
		DWORD offset_g_names = 0x65F36C0;
		...
		DWORD offset_game_instance = 0x0220; //UWolrd->OwningGameInstance
		...
		DWORD offset_player_name = 0x310; //struct FString PlayerNamePrivate; // 0x3e8 
		

		DWORD offset_SpectatorNum = 0x598;
		DWORD offset_CharacterLevel = 0x430;
		DWORD offset_KillNum = 0x728;
		DWORD offset_AccountLevel = 0x440; 
		DWORD offset_IsBot = 0x232;
		DWORD offset_Team = 0xa70;
		DWORD offset_OS = 0x638;

		DWORD offset_player_state = 0x248; //APawn->PlayerState
		DWORD offset_actor_mesh = 0x288; //ACharacter->Mesh
		DWORD offset_bone_array = 0x488; //0x3E0

		DWORD offset_component_to_world = 0x250;
		DWORD offset_ranged_weapon_component = 0x4c8;
		DWORD offset_equipped_weapon_type = 0x3d4;
		...
		DWORD offset_last_render_time = 0x2b0; // AServerStatReplicator -> NumReplicatedActors
